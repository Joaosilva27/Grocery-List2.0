export default function TinyLoadingScreen() {
  return (
    <div className="flex flex-col items-center justify-center bg-gray-900 gap-4 mt-4">
      ...
      <div className="flex items-center gap-2">
        <span className="text-green-500 font-semibold text-lg md:text-xl animate-pulse">
